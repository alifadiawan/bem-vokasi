@extends('layout.main')
@section('content')
<div class="w-100 overflow-hidden position-relative bg-black text-white" style="height: 100vh;">
    {{-- <div class="position-absolute w-100 h-100 bg-black opacity-75 top-0 start-0"></div> --}}
    <div class="container py-vh-4 position-relative mt-5">
        <div class="row d-flex align-items-center justify-content-end py-vh-5">
            <div class="col">
                <p class="h5 text-secondary fw-lighter" data-aos="fade-right" data-aos-duration="1500"
                    data-aos-delay="100">Hi voks, selamat datand di website resmi</p>
                <h1 class="display-huge mt-3 mb-3 lh-1" data-aos="fade-left" data-aos-duration="1500"
                    data-aos-delay="300">BEM Fakultas Vokasi</h1>
                <p class="h5 text-secondary fw-lighter" data-aos="fade-right" data-aos-duration="1500"
                    data-aos-delay="500">Kabinet Gelora Karya</p>
            </div>
            {{-- <div class="col">
            ...
            <div class="col text-center floating" data-aos="fade-left" data-aos-duration="2000"
                data-aos-delay="700">
                <div class="">
    ...
    <div class="container-fluid px-vw-5">
        ...
        <div class="row d-flex align-items-center position-relative justify-content-center px-0 g-5">
            <div class="col-12 col-lg-6">
                <img src="{{ asset('assets/img/webp/abstract18.webp') }}" width="2280" height="1732"
                    alt="abstract image" class="img-fluid position-relative rounded-5 shadow"
                    data-aos="fade-up">
            </div>
            <div class="col-12 col-md-6 col-lg-3">
                <img src="{{ asset('assets/img/webp/abstract6.webp') }}" width="1116" height="1578"
                    alt="abstract image" class="img-fluid position-relative rounded-5 shadow" data-aos="fade-up"
                    data-aos-duration="2000">
            </div>
            <div class="col-12 col-md-6 col-lg-3">
                <img src="{{ asset('assets/img/webp/abstract9.webp') }}" width="1116" height="848"
                    alt="abstract image" class="img-fluid position-relative rounded-5 shadow" data-aos="fade-up"
...
<div class="bg-black" style="height: 100vh">
    <div class="container">
        <div class="row text-center my-5" data-aos="fade-down">
            <h1>Perkenalan Logo </h1>
        </div>
        <div class="row align-items-center justify-content-between" data-aos="fade" data-aos-duration="1500">
            <div class="col" data-aos="fade-right" data-aos-duration="1500" data-aos-delay="300">
                <img src="https://placehold.co/600x400" alt="">
            </div>
            <div class="col" data-aos="fade-left" data-aos-duration="1500" data-aos-delay="500">
                <h1>Lorem Ipsum</h1>
                <span>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Est eligendi voluptates pariatur
                    aliquid, aperiam recusandae, quo ea et eum, incidunt totam? Placeat, inventore? Assumenda
                    perspiciatis officiis beatae. Perferendis, dolor numquam?</span>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row gx-5">
            <div class="col-12 col-md-6">
                <div class="card bg-transparent mb-5" data-aos="zoom-in-up">
                    <div class="bg-dark shadow rounded-5 p-0">
                        <img src="assets/img/webp/abstract3.webp" width="582" height="327"
                ...
                <div class="card bg-transparent" data-aos="zoom-in-up">
                    <div class="bg-dark shadow rounded-5 p-0">
                        <img src="assets/img/webp/abstract2.webp" width="582" height="442"
                            alt="abstract image" class="img-fluid rounded-5 no-bottom-radius" loading="lazy">
                        <div class="p-5">
                            <h2 class="fw-lighter">Ipsum dolor est</h2>
                            <p class="pb-4 text-secondary">Lorem ipsum dolor sit amet, consetetur sadipscing
            ...
            <div class="col-12 col-md-6">
                ...
                <div class="card bg-transparent mb-5 mt-5" data-aos="zoom-in-up">
                    <div class="bg-dark shadow rounded-5 p-0">
                        <img src="assets/img/webp/abstract17.webp" width="582" height="390"
                            alt="abstract image" class="img-fluid rounded-5 no-bottom-radius" loading="lazy">
                        <div class="p-5">
                            <h2 class="fw-lighter">Ipsum dolor est</h2>
                            <p class="pb-4 text-secondary">Lorem ipsum dolor sit amet, consetetur sadipscing
                ...
                <div class="card bg-transparent" data-aos="zoom-in-up">
                    <div class="bg-dark shadow rounded-5 p-0">
                        <img src="assets/img/webp/abstract4.webp" width="582" height="327"
                            alt="abstract image" class="img-fluid rounded-5 no-bottom-radius" loading="lazy">
                        <div class="p-5">
                            <h2 class="fw-lighter">Ipsum dolor est</h2>
                            <p class="pb-4 text-secondary">Lorem ipsum dolor sit amet, consetetur sadipscing
    ...
    <div class="container px-vw-5 py-vh-5">
        <div class="row d-flex align-items-center">
            ...
            <div class="col-12 col-lg-7">
                <img class="img-fluid rounded-5 mb-n5 shadow" src="assets/img/webp/person9.webp"
                    width="512" height="512" alt="a nice person" loading="lazy"
                    data-aos="zoom-in-right">
                <img class="img-fluid rounded-5 ms-5 mb-n5 shadow" src="assets/img/webp/person11.webp"
...
<div class="container-fluid px-vw-5 position-relative" data-aos="fade">
    ...
    <div class="position-relative py-vh-5 bg-cover bg-center rounded-5"
        style="background-image: url(assets/img/webp/abstract12.webp)">
        <div class="container bg-black px-vw-5 py-vh-3 rounded-5 shadow">
            <div class="row d-flex align-items-center">
                ...
                <div class="col-6 d-flex align-items-center bg-dark shadow rounded-5 p-0"
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-12">
                            <img src="{{ asset('assets/img/webp/person103.webp') }}" width="684"
                                height="457" alt="our CEO with some nice numbers"
            ...
            <div class="col-12 col-lg-6">
                <div class="rounded-5 bg-black p-5 shadow" data-aos="zoom-in-right">
                    ...
                    <div
                        ...
                        <img src="assets/img/webp/person14.webp" width="96" height="96"
                ...
                <div class="rounded-5 bg-black p-5 shadow mt-5" data-aos="zoom-in-right">
                    ...
                    <div
                        class="d-flex justify-content-start align-items-center border-top border-secondary pt-3">
                        <img src="{{ asset('assets/img/webp/person13.webp') }}" width="96" height="96"
                            class="rounded-circle me-3" alt="a nice person" data-aos="fade" loading="lazy">
                        <div>
                            <span class="h6 fw-5">Jane Doemunsky</span><br>
                            <small class="text-secondary">COO, The Boo Corp.</small>
            ...
            <div class="col-12 col-lg-6">
                ...
                <div class="rounded-5 bg-black p-5 shadow mt-5 gradient" data-aos="zoom-in-left">
                    ...
                    <div class="d-flex justify-content-start align-items-center border-top pt-3">
                        <img src="{{ asset('assets/img/webp/person16.webp') }}" width="96" height="96"
                            class="rounded-circle me-3" alt="a nice person" data-aos="fade" loading="lazy">
                        <div>
                            <span class="h6 fw-5">Jane Doemunsky</span><br>
