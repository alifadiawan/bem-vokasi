            ...
            <div class="container-fluid px-vw-5">
                ...
                <div class="row d-flex align-items-center position-relative justify-content-center px-0 g-5">
                    <div class="col-12 col-lg-6">
                        <img src="{{ asset('assets/img/webp/abstract18.webp')}}" width="2280" height="1732" alt="abstract image"
                            class="img-fluid position-relative rounded-5 shadow" data-aos="fade-up">
                    </div>
                    <div class="col-12 col-md-6 col-lg-3">
                        <img src="{{ asset('assets/img/webp/abstract6.webp')}}" width="1116" height="1578" alt="abstract image"
                            class="img-fluid position-relative rounded-5 shadow" data-aos="fade-up"
                            data-aos-duration="2000">
                    </div>
                    <div class="col-12 col-md-6 col-lg-3">
                        <img src="{{ asset('assets/img/webp/abstract9.webp')}}" width="1116" height="848" alt="abstract image"
                            class="img-fluid position-relative rounded-5 shadow" data-aos="fade-up"
            ...
            <div class="container px-vw-5 py-vh-5">
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-12 col-lg-7">
                        <img class="img-fluid rounded-5 mb-n5 shadow" src="assets/img/webp/person9.webp" width="512"
                    ...
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-6 d-flex align-items-center bg-dark shadow rounded-5 p-0"
                            ...
                            <div class="row d-flex justify-content-center">
                                <div class="col-12">
                                    <img src="{{ asset('assets/img/webp/person103.webp')}}" width="684" height="457"
