...
<head>
    ...
    <title>BEM Fakultas Vokasi Unair @php echo date('Y') @endphp</title>
    ...
    <main>
            ...
            <div class="container py-vh-4 position-relative mt-5">
                <div class="row d-flex align-items-center justify-content-end py-vh-5">
                    <div class="col" data-aos="fade-right">
                        <span class="h5 text-secondary fw-lighter">Hi voks, selamat datand di website resmi</span>
                        <h1 class="display-huge mt-3 mb-3 lh-1">BEM Fakultas Vokasi</h1>
                        <span class="h5 text-secondary fw-lighter">Kabinet Gelora Karya</span>
                    </div>
                    {{-- <div class="col">
                    ...
                    <div class="col text-center floating" data-aos="fade-left">
                        <div class="">
        ...
        <div class="bg-black" style="height: 100vh">
            <div class="container">
                ...
                <div class="row align-items-center justify-content-between" data-aos="fade">
                    <div class="col" data-aos="fade-right" data-aos-duration="10000">
                        <img src="https://placehold.co/600x400" alt="">
                    </div>
                    <div class="col" data-aos="fade-left" data-aos-duration="10000">
                        <h1>Lorem Ipsum</h1>
