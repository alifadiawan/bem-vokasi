    ...
    <section id="hero" class="hero section">
        ...
        <div class="container">
            <div class="row text-center justify-content-center align-items-center">
                <div class="col-lg-12 my-lg-5" data-aos="fade-down" data-aos-duration="800">
                    <h2 class="">Struktur Organisasi</h2>
                </div>
            </div>
            <div class="row text-center justify-content-center align-items-center">
                <div class="col-12 col-lg-6" data-aos="fade-left" data-aos-duration="800" data-aos-delay="800">
                ...
                <div class="col-12 col-lg-6" data-aos="fade-right" data-aos-duration="800" data-aos-delay="1000">
                ...
                <div class="pb-5 col-12 col-lg-4" data-aos="zoom-in-up" id="card-id">
                    <a href="/profile/kementrian-sekben">
                        <img src="{{ asset('ppp/img/kementrian/SEKBEN.png') }}" alt="" data-aos="fade-left"
                            data-aos-duration="1000" class="img-fluid" style="max-width: 350px;">
                    </a>
                </div>
                <div class="pb-5 col-12 col-lg-4" data-aos="zoom-in-up" id="card-id">
