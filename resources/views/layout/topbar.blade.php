<nav id="navScroll" class="navbar navbar-dark bg-black fixed-top px-vw-5" tabindex="0">
    <div class="container">
        <a class="navbar-brand pe-md-4 fs-4 col-12 col-md-auto text-center" href="index.html">
            ...
            <span class="ms-md-1 mt-1 fw-bolder me-md-5">BEM Vokasi</span>
        </a>

        <ul class="navbar-nav me-auto mb-2 mb-lg-0 list-group list-group-horizontal align-items-center">
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link fs-5" href="/vokasi-news" aria-label="A system message page">
                    News
                </a>
            </li>
            {{-- <li class="nav-item">
